...
export default function Dashboard() {
  ...
  return (
    <div className="">
      <div className="w-[100%] p-[30px_20px] bg-[#117aca] relative">
        ...
        {hour >= 12 ? (hour >= 17 ? "Good evening" : "Good afternoon") : "Good morning"}
          ...
          <div className="flex items-center gap-[10px] mt-[10px]">
            ...
            <Link
              className="p-[5px_20px] rounded-full bg-white text-[#117aca] text-[12px]"
      ...
      <div className="p-[20px]">
        ...
        <div className="w-full rounded-[5px] overflow-hidden border border-[#117aca]">
          <div className="p-[10px_20px] bg-[#117aca] text-white text-[14px]">
            Bank accounts(1)
          </div>
